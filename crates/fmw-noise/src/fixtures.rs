...
fn the_capture_grid_snap_is_load_bearing_on_the_vulcanus_elevation_surface() {
    let elev_fixture = load("test/fixtures/oracle-vulcanus-elevation.seed123456.json");
    let temp_fixture = load("test/fixtures/oracle-vulcanus-temperature.seed123456.json");
